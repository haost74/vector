...
function Table(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _TableBody2.default,
      null,
      (0, _map3.default)(tableData, function (data, index) {
...
Table.propTypes = {
  ...
  children: _lib.customPropTypes.every([_lib.customPropTypes.disallow(['headerRow', 'renderBodyRow', 'footerRow', 'tableData']), _react.PropTypes.node]),
  ...
  footerRow: _react.PropTypes.oneOfType([_react.PropTypes.array, _react.PropTypes.element]),

  /** Shorthand for a TableRow to be placed within Table.Header. */
  headerRow: _react.PropTypes.oneOfType([_react.PropTypes.array, _react.PropTypes.element]),
   ...
   */
  renderBodyRow: _lib.customPropTypes.every([_lib.customPropTypes.demand(['tableData']), _react.PropTypes.func]),
  ...
  tableData: _lib.customPropTypes.every([_lib.customPropTypes.demand(['renderBodyRow']), _react.PropTypes.array]),
