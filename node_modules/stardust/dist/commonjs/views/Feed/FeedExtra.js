...
FeedExtra.propTypes = {
  ...
  images: _lib.customPropTypes.every([_lib.customPropTypes.disallow(['text']), _react.PropTypes.oneOfType([_react.PropTypes.bool, _react.PropTypes.arrayOf(_react.PropTypes.string)]), _lib.customPropTypes.givenProps({ images: _react.PropTypes.arrayOf(_react.PropTypes.string).isRequired }, _lib.customPropTypes.disallow(['children']))]),
